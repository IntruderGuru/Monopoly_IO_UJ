...
class AkcjaKartOkno(Okno):
    ...
    def wyswietl(self, screen: pygame.Surface):
        ...
        if self.czy_szansa:
            ...
            szansa_png_wyswietlane = pygame.transform.scale(self.szansa_png, (0.64 * self.W, 0.5 * self.H))
            screen.blit(szansa_png_wyswietlane, (self.W * 0.2, self.H * 0.15))
            self.wyswietl_lamana_tresc_karty(screen, self.tresc_karty, self.W * 0.5, self.H * 0.3)
    ...
    def wyswietl_lamana_tresc_karty(self, screen, tekst: str, start_x, start_y) -> float:
        """
